...
export function modifyWebpackConfig(config, stage) {
  ...
  config._config.resolve.alias['scrollmagic.debug'] = 'scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators.js'
...
function moveBundle() {
  ...
  fs.copySync(bundle, path.join(__dirname, 'public', newPath))
